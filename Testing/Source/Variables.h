...
Vector <std::string> s_cylrand;
Vector <std::string> s_sphrand;
std::string s_cuberand;
std::string s_cubepat;
Vector <Vector<Real>> cube;
Vector <Vector<Real>> sphere;
Vector <Vector<Real>> cylinder;
Vector <Vector<Real>> ellipse;
Vector <Vector<Real>> cylrand;
Vector <Vector<Real>> sphrand;
Vector<Real> cuberand;
Vector<Real> cubepat;
...
void (*Mu)(MultiFab& ray,MultiFab& day);
void (*function_A)();
void (*function_B)();
void (*function_C)();
