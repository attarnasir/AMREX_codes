...
void Function_Q_2D(int i, int j, int k, amrex::Array4<Real const> const& phi, GpuArray<Real,AMREX_SPACEDIM> delta, int a, int b, Array2D<Real,0,AMREX_SPACEDIM*2,0,AMREX_SPACEDIM-1, Order::C> &qab){

//Calculating qab[X] at cent, iph, imh, jph, jmh, kph, kmh---------------------------------------------------------------------------------------------------------------
...
//Calculating qab[Y] at cent, iph, imh, jph, jmh, kph, kmh---------------------------------------------------------------------------------------------------------------
...
AMREX_GPU_DEVICE AMREX_FORCE_INLINE
void Function_Q_3D(int i, int j, int k, amrex::Array4<Real const> const& phi, GpuArray<Real,AMREX_SPACEDIM> delta, int a, int b, Array2D<Real,0,AMREX_SPACEDIM*2,0,AMREX_SPACEDIM-1, Order::C> &qab){
...
//Calculating qab[Z] at cent, iph, imh, jph, jmh, kph, kmh---------------------------------------------------------------------------------------------------------------
