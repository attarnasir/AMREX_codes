...
void (*function_B)();
void (*function_C)();
void (*free_energy)(int i, int j, int k, Array3D<Real,0,phasecount-1,0,compcount-2,0,compcount-2, Order::C> AA, Array2D<Real,0,phasecount-1,0,compcount-2, Order::C> BB, Array1D <Real,0,phasecount-1> CC, Array1D<Real,0,phasecount-1> &fe , Array2D<Real,0,phasecount-1,0,compcount-2, Order::C> &c, int numcomp, int a);
