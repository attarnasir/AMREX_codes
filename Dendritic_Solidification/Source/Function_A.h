			...
			for(int a=0; a<numphase; a++){
					...
					for(int b=0; b<numphase; b++){
							...
							if(b!=a){
								...
								//Calculating qab----------------------------------------------------------------------------------
								Function_Q_2D(i,j,k, phiOld, delta, a, b, qab);
			...
			for(int a=0; a<numphase; a++){
					...
					for(int b=0; b<numphase; b++){
							...
							if(b!=a){
								...
								//Calculating qab----------------------------------------------------------------------------------	
								Function_Q_3D(i,j,k, phiOld, delta, a, b, qab);
			...
			for(int a=0; a<numphase; a++){
					...
					for(int b=0; b<numphase; b++){
							...
							if(b!=a){
								...
								Vec_rot_2D(i, j, k, a, b, qab, r_qab, matrot_x, matrot_y, matrot_z);

								if(anisotropy_type == 4){
									
									//Calculate dadq-------------------------------------------------------------------------------
									dAdq_2D(i, j, k, dabbb, r_qab, dadq, q2, a, b);

									//Calculate ac---------------------------------------------------------------------------------
									function_ac_2D(i, j, k, dabbb, r_qab, ac, q2, a, b);
								}
								...
								Vec_rot_2D(i, j, k, a, b, dqdphi, r_dqdphi, matrot_x, matrot_y, matrot_z);
								...
								Inv_vec_rot_2D(i,j,k,a,b,dadq,r_dadq, matrot_x, matrot_y, matrot_z);
			...
			for(int a=0; a<numphase; a++){
					...
					for(int b=0; b<numphase; b++){
							...
							if(b!=a){
								...
								//Rotation of normal vector by the relevant angle--------------------------------------------------
								Vec_rot_3D(i, j, k, a, b, qab, r_qab, matrot_x, matrot_y, matrot_z);


								if(anisotropy_type == 6){
									//Calculate dadq ------------------------------------------------------------------------------
									dAdq_3D(i, j, k, dabbb, r_qab, dadq, q2, a, b);

									//Calculate ac --------------------------------------------------------------------------------
									function_ac_3D(i, j, k, dabbb, r_qab, ac, q2, a, b);
								}
								...
								//Rotating dqdphi by the desired angle ---------------------------------------------------------------
								Vec_rot_3D(i, j, k, a, b, dqdphi, r_dqdphi, matrot_x, matrot_y, matrot_z);
								...
								//Inverse rotation of dadq by the desired angle ---------------------------------------------------------------------------
								Inv_vec_rot_3D(i,j,k,a,b,dadq,r_dadq, matrot_x, matrot_y, matrot_z);
